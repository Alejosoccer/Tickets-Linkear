                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="section-headline text-center">
                            <h2 style="margin-top: 50px;">Realizar búsqueda</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <!-- single-well start-->
                    <div class="col-md-12 col-sm-12 col-xs-12" style="margin: 50px 0 20px 0" >
                        <form action="{{url('/verificar')}}" method="GET">
                        @csrf
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                <label for="origen"><i class="fa fa-map-marker"></i> Origen</label>
                                <select class="form-control" name="select_origen" id="select_origen">
                                    <option disabled>Selecciona una opción</option>
                                    @foreach ($cooperatives as $item)
                                    <option value="{{$item->origen}}">{{$item->origen}}</option>
                                    @endforeach
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                <label for="destino"><i class="fa fa-map-marker"></i> Destino</label>
                                <select class="form-control" name="select_destino" id="select_destino">
                                    <option disabled>Selecciona una opción</option>
                                    @foreach ($cooperatives as $item)
                                    <option value="{{$item->destino}}">{{$item->destino}}</option>
                                    @endforeach
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <label for="fecha"><i id="fa-icon" class="fa fa-calendar" style="margin-bottom:8px"></i> Fecha de salida</label>
                            <input type="date" id="fecha-in" name="fecha-in" class="form-control" />
                        </div>

                        <div class="col-md-3 col-sm-3 col-xs-12" style="margin-top: 15px;">
                            <button type="submit" class="form-btn-search" id="filtrar_info"> Verificar disponibilidad</button>
                        </div>
                        </form>
                    </div>
                </div>
